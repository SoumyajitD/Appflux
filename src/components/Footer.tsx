    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <a href="#" className="flex items-center font-bold text-2xl text-white mb-4">
              <span className="text-blue-400">app</span>flux
            </a>
            <p className="text-gray-400 mb-4">
              We create exceptional digital experiences through innovative web and mobile applications.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Custom CMS Solutions</a></li>
              <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Performance Optimization</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © 2025 AppFlux. All rights reserved.
          </div>
